...
export default function DownloadCta() {
  ...
  return (
    <section id="download" className="py-24 bg-midnight text-white relative overflow-hidden">
      {/* Absolute Ambient Background Glows */}
      <div className="absolute pointer-events-none w-[500px] h-[500px] top-0 right-0 bg-brand-500/20 rounded-full blur-3xl -z-0" />
      <div className="absolute pointer-events-none w-[400px] h-[400px] bottom-0 left-0 bg-purple-600/20 rounded-full blur-3xl -z-0" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-brand-500/20 border border-brand-400/40 text-brand-300 font-extrabold text-xs uppercase tracking-wider font-mono">
            ...
            <p className="text-slate-300 text-base sm:text-lg max-w-xl mx-auto lg:mx-0 font-normal leading-relaxed">
              Téléchargez VendMoi gratuitement. Vos 4 premiers crédits IA sont offerts immédiatement, sans carte bancaire requise.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
              ...
              >
                ...
                <span>Installer sur Android (APK)</span>
              </a>

              <button
                onClick={() => setShowQr(!showQr)}
                className="btn-dark-3d w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-6 py-4 rounded-2xl bg-slate-900 text-slate-200 font-bold text-base border border-slate-800"
              >
          ...
          <div className="lg:col-span-5 flex justify-center">
            <div className="p-8 sm:p-10 rounded-[36px] bg-slate-900/90 border border-slate-800 backdrop-blur-xl shadow-2xl text-center space-y-6 max-w-sm w-full">
              
              <div className="space-y-1">
                <span className="text-xs font-black uppercase tracking-wider text-brand-400 font-mono">
              ...
              {/* QR Code Frame */}
              <div className="relative aspect-square w-52 mx-auto rounded-2xl p-4 bg-white shadow-xl flex items-center justify-center border-4 border-brand-500/30">
              ...
              <p className="text-xs text-slate-400 leading-relaxed font-medium">
                Pointez votre smartphone vers ce code pour lancer immédiatement l’application VendMoi.
              </p>
